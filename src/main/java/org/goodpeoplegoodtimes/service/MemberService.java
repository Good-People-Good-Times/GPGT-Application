...
public class MemberService implements UserDetailsService {
    ...
    public ProfileResponseDto getProfile(String email) {
        ProfileResponseDto profileResponseDto = memberRepository.fetchProfileByEmail(email);
        profileResponseDto.setPartyJoinedCount(partyMemberRepository.getJoinedPartyCountByEmail(email));
        return profileResponseDto;
    }

    public ProfileResponseDto getProfile(Long memberId) {
        ProfileResponseDto profileResponseDto = memberRepository.fetchProfileById(memberId);
        profileResponseDto.setPartyJoinedCount(partyMemberRepository.getJoinedPartyCountById(memberId));
        return profileResponseDto;
    }
